        ...
        const relatorios = [
            {
                ...
                titulo: 'Relatório de Gestão Administrativa do Help Desk',
                descricao:
                    'Apresenta indicadores gerais dos chamados, tempos médios e distribuição por categoria.',
                icon: FileBarChart,
            },
        ];
                    ...
                    >
                            ...
                            <CardContent className="p-5">
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="border-stone-600/40 bg-stone-950/40 pl-10 text-stone-100 placeholder:text-stone-500"
                                    />
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <div className="grid gap-4">
                            ...
                            {relatoriosDisponiveis.length === 0 && (
                                <Card className="border-stone-700/40 bg-stone-900/50">
                                    <CardContent className="p-10 text-center">
                                        <Search className="mx-auto mb-3 size-8 text-stone-500" />
